...
const CreateReview = (props) => {
  ...
  const reviewFormHandler = (e) => {
    ...
    axios
      .post(
        `http://localhost:8000/api/review/${gameId}`,
        { userId: passUserId, reviewText, rating },
    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          <form
            id="reviewForm"
            onSubmit={reviewFormHandler}
            className="border border-primary p-2 border-5 rounded"
          >
        ...
        <Modal.Footer>
          ...
          <button form="reviewForm" className="btn btn-primary mt-1">
            Done
          </button>
